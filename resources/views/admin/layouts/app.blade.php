...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('assets/admin/assets/images/favicon.svg') }}">
                    ...
                    <ul class="menu">
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                ...
                                <li>
                                    <a href="{{ route('admin.materi') }}"> Material </a>
                                </li>
        ...
        <div id="main">
                        ...
                        <li class="dropdown">
                            <a href="#" data-bs-toggle="dropdown"
                                ...
                                <div class="avatar me-1">
                                    <img src="{{ asset('assets/admin/assets/images/avatar/AvatarWiwid.jpg') }}"
                                        alt="" srcset="">
                                </div>
            ...
            <footer>
                <div class="footer clearfix mb-0 text-muted">
                    ...
                    <div class="float-end">
                        <p>Crafted with <span class='text-danger'><i data-feather="heart"></i></span> by <a>Arkae</a>
                        </p>
                    </div>
                </div>
            </footer>
